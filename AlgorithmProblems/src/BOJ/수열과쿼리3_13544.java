...
public class 수열과쿼리3_13544 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 0; t < m; t++) {
            ...
            int i = (Integer.parseInt(st.nextToken()) ^ last) - 1;
            int j = (Integer.parseInt(st.nextToken()) ^ last) - 1;
            int k = (Integer.parseInt(st.nextToken()) ^ last);

            last = countOverK(1, 0, n - 1, i, j, k);
